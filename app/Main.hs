...
config = Config { _bodies = [ Body { _solid = mkSphere (V3 0 (-0.5) 7) 0.5
                                   , _texture = mkDiffuse _red 0.7 0.3 50
                                   }
                            , Body { _solid = mkSphere (V3 0.3 (-0.5) 2) 1
                                   , _texture = mkTransparent 0 0.99 1.5
                                   }
                            , Body { _solid = mkSphere (V3 1 (-0.3) 6.7) 0.3
                                   , _texture = mkDiffuse _blue 0.6 0.4 10
                                   }
                            , Body { _solid = mkDisk (V3 (-1) 0 7) (V3 1 0 (-1)) 1
                                   , _texture = mkReflective 0.99
                                   }
                ...
                , _lights = [ Light { _intensity = _white
                                    , _position = V3 0 10 (-2)
                                    }
                ...
                , _camera = mkCamera (V3 0 0 (-10)) (V2 4 3) (V2 1600 1200) 4
                , _ambient = mkColor 0.0 0.749 1.0
                , _depth = 10
                }
           
main :: IO ()
main = config2Image config "image.bmp"
